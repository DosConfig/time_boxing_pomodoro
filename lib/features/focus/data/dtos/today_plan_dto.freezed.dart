...
@override
String toString() {
  return 'TimeBoxDto(id: $id, title: $title, timeRange: $timeRange, durationSeconds: $durationSeconds)';
}
...
class _TimeBoxDto extends TimeBoxDto {
  const _TimeBoxDto({this.id = '', this.title = '', this.timeRange = '', this.durationSeconds = 30 * 60}): super._();
...
mixin _$TodayPlanDto {
 ...
 int get schemaVersion; String get dateKey; List<String> get brainDump; List<String> get reminders; List<String> get topPriorities; List<TimeBoxDto> get timeBoxes; String get activeTimeBoxId; int get completedSessions;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is TodayPlanDto&&(identical(other.schemaVersion, schemaVersion) || other.schemaVersion == schemaVersion)&&(identical(other.dateKey, dateKey) || other.dateKey == dateKey)&&const DeepCollectionEquality().equals(other.brainDump, brainDump)&&const DeepCollectionEquality().equals(other.reminders, reminders)&&const DeepCollectionEquality().equals(other.topPriorities, topPriorities)&&const DeepCollectionEquality().equals(other.timeBoxes, timeBoxes)&&(identical(other.activeTimeBoxId, activeTimeBoxId) || other.activeTimeBoxId == activeTimeBoxId)&&(identical(other.completedSessions, completedSessions) || other.completedSessions == completedSessions));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,schemaVersion,dateKey,const DeepCollectionEquality().hash(brainDump),const DeepCollectionEquality().hash(reminders),const DeepCollectionEquality().hash(topPriorities),const DeepCollectionEquality().hash(timeBoxes),activeTimeBoxId,completedSessions);

@override
String toString() {
  return 'TodayPlanDto(schemaVersion: $schemaVersion, dateKey: $dateKey, brainDump: $brainDump, reminders: $reminders, topPriorities: $topPriorities, timeBoxes: $timeBoxes, activeTimeBoxId: $activeTimeBoxId, completedSessions: $completedSessions)';
}
...
@useResult
$Res call({
 int schemaVersion, String dateKey, List<String> brainDump, List<String> reminders, List<String> topPriorities, List<TimeBoxDto> timeBoxes, String activeTimeBoxId, int completedSessions
});
...
/// Create a copy of TodayPlanDto
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? schemaVersion = null,Object? dateKey = null,Object? brainDump = null,Object? reminders = null,Object? topPriorities = null,Object? timeBoxes = null,Object? activeTimeBoxId = null,Object? completedSessions = null,}) {
  return _then(_self.copyWith(
schemaVersion: null == schemaVersion ? _self.schemaVersion : schemaVersion // ignore: cast_nullable_to_non_nullable
as int,dateKey: null == dateKey ? _self.dateKey : dateKey // ignore: cast_nullable_to_non_nullable
as String,brainDump: null == brainDump ? _self.brainDump : brainDump // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int schemaVersion,  String dateKey,  List<String> brainDump,  List<String> reminders,  List<String> topPriorities,  List<TimeBoxDto> timeBoxes,  String activeTimeBoxId,  int completedSessions)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _TodayPlanDto() when $default != null:
return $default(_that.schemaVersion,_that.dateKey,_that.brainDump,_that.reminders,_that.topPriorities,_that.timeBoxes,_that.activeTimeBoxId,_that.completedSessions);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int schemaVersion,  String dateKey,  List<String> brainDump,  List<String> reminders,  List<String> topPriorities,  List<TimeBoxDto> timeBoxes,  String activeTimeBoxId,  int completedSessions)  $default,) {final _that = this;
switch (_that) {
case _TodayPlanDto():
return $default(_that.schemaVersion,_that.dateKey,_that.brainDump,_that.reminders,_that.topPriorities,_that.timeBoxes,_that.activeTimeBoxId,_that.completedSessions);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int schemaVersion,  String dateKey,  List<String> brainDump,  List<String> reminders,  List<String> topPriorities,  List<TimeBoxDto> timeBoxes,  String activeTimeBoxId,  int completedSessions)?  $default,) {final _that = this;
switch (_that) {
case _TodayPlanDto() when $default != null:
return $default(_that.schemaVersion,_that.dateKey,_that.brainDump,_that.reminders,_that.topPriorities,_that.timeBoxes,_that.activeTimeBoxId,_that.completedSessions);case _:
  return null;
...
class _TodayPlanDto extends TodayPlanDto {
  const _TodayPlanDto({this.schemaVersion = 1, this.dateKey = '', final  List<String> brainDump = const <String>[], final  List<String> reminders = const <String>[], final  List<String> topPriorities = const <String>['', '', ''], final  List<TimeBoxDto> timeBoxes = const <TimeBoxDto>[], this.activeTimeBoxId = '', this.completedSessions = 0}): _brainDump = brainDump,_reminders = reminders,_topPriorities = topPriorities,_timeBoxes = timeBoxes,super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _TodayPlanDto&&(identical(other.schemaVersion, schemaVersion) || other.schemaVersion == schemaVersion)&&(identical(other.dateKey, dateKey) || other.dateKey == dateKey)&&const DeepCollectionEquality().equals(other._brainDump, _brainDump)&&const DeepCollectionEquality().equals(other._reminders, _reminders)&&const DeepCollectionEquality().equals(other._topPriorities, _topPriorities)&&const DeepCollectionEquality().equals(other._timeBoxes, _timeBoxes)&&(identical(other.activeTimeBoxId, activeTimeBoxId) || other.activeTimeBoxId == activeTimeBoxId)&&(identical(other.completedSessions, completedSessions) || other.completedSessions == completedSessions));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,schemaVersion,dateKey,const DeepCollectionEquality().hash(_brainDump),const DeepCollectionEquality().hash(_reminders),const DeepCollectionEquality().hash(_topPriorities),const DeepCollectionEquality().hash(_timeBoxes),activeTimeBoxId,completedSessions);
...
/// Create a copy of TodayPlanDto
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? schemaVersion = null,Object? dateKey = null,Object? brainDump = null,Object? reminders = null,Object? topPriorities = null,Object? timeBoxes = null,Object? activeTimeBoxId = null,Object? completedSessions = null,}) {
  return _then(_TodayPlanDto(
schemaVersion: null == schemaVersion ? _self.schemaVersion : schemaVersion // ignore: cast_nullable_to_non_nullable
as int,dateKey: null == dateKey ? _self.dateKey : dateKey // ignore: cast_nullable_to_non_nullable
as String,brainDump: null == brainDump ? _self._brainDump : brainDump // ignore: cast_nullable_to_non_nullable
