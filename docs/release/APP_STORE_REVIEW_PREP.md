# App Store Review Preparation — iOS 1.0.0+16
...
- TestFlight build target: `1.0.0+16`

## Required Before Submission

- [ ] Build `1.0.0+16` appears as processed in App Store Connect
...
Do not declare Calendar Events for `1.0.0+16`. The app also does not collect
